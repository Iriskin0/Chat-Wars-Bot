...
Как запустить:<br />
  ...
  По желанию можно поменять админ кмд - при отправке сообщений типа #help в личку можно будет обращаться к скрипту, blue_oyster_cmd - при получении приказов будет ставить атаку на определенный замок, по умолчанию уходит в защиту своего.
