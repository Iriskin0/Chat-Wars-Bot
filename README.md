...
В данный момент ведется разработка второй версии бота, переписанная под другой враппер, что позволит отлавливать пины на каналах и запускать бота на виндоус. Пожалуйста, оставляйте иссуи или пишите в личку https://telegram.me/iriskin0 с предложениями, я постараюсь их реализовать<br />
Разраб Chat Wars объявил о волне банов, так что кому важен аккаунт, не рискуйте, не используйте бота. Во второй версии ожидается более человекоподобное поведение
-----------------------<br />
